  ...
  return (
    <div className='px-5 py-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis impedit accusantium similique vitae placeat minus non sequi explicabo laboriosam veniam?</p>
        <form className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black shadow-[-7px_7px_0px_#000000]'>
          ...
          <button type='submit' className='border-l bg-orange-500 text-white border-black py-4 px-4 sm:px-8 active:bg-gray-600 active:text-white'>Subscribe</button>
        </form>
      </div>
    </div>
  )
